...
class UapDatabase(models.Model):
    ...
    partner_id = fields.Many2one("res.partner", string="Owner Organisation", index=True, ondelete="restrict")
    ...
    language = fields.Selection(
        selection=[
            ...
            ("de", "German"), ("es", "Spanish"), ("pt", "Portuguese"), ("other", "Other"),
        ],
    ...
    encounter_ids = fields.One2many("uap.encounter", "database_id", string="Encounters")
    encounter_count = fields.Integer(string="# Encounters", compute="_compute_encounter_count", store=False)
